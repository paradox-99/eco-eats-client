            ...
            <div className="navbar font-medium">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 font-manrope">
                            {routes}
                        </ul>
                    </div>
                    <a className="btn btn-ghost text-xl font-montserrat"><img src={logo} alt="Logo" className="w-36"/></a> 
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 font-manrope text-xl">
                        {routes}
                    </ul>
                </div>
                <div className="navbar-end">
                    <a className="btn btn-primary text-xl font-montserrat">Login</a>
                </div>
