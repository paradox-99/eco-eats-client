...
const Footer = () => {
    return (
        <div className="mt-14">
            <footer className="footer place-items-center lg:place-items-start p-2 md:p-5 lg:p-10 xl:px-28 bg-base-200 text-base-content font-manrope">
                <aside className="flex flex-col items-center md:items-start">
                    <h1 className="font-pirata text-7xl text-primary text-center">EcoEats</h1>
                    <p className="text-center">EcoEats Food Sharing Ltd.<br />Providing reliable service since 2015</p>
                </aside>
                ...
                <form className="flex flex-col items-center md:items-start">
                    <h6 className="footer-title font-montserrat">Newsletter</h6>
                    <fieldset className="form-control md:w-80">
                        <label className="label justify-center md:justify-start">
                            <span className="label-text">Enter your email address</span>
                        </label>
                        <div className="join">
                            <input type="text" placeholder="username@site.com" className="input input-bordered join-item pr-0" />
                            <button className="btn btn-primary join-item">Subscribe</button>
                        </div>
                    </fieldset>
                </form>
            </footer>
            <footer className="footer items-center place-items-center md:place-items-start p-2 md:p-5 lg:p-10 xl:px-28 bg-base-200">
